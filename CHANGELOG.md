...
## [0.9.0](https://github.com/criterion-rs/criterion.rs/compare/criterion-v0.8.2...criterion-v0.9.0) - 2026-03-07
...
- don't obtain output directory or run cargo metadata in test mode ([#63](https://github.com/criterion-rs/criterion.rs/pull/63))
