...
pub enum AxisScale {
    ...
    /// Axes scale base-10 logarithmically
    Logarithmic,

    /// Axes scale base-2 logarithmically
    Log2,
}
...
impl PlotConfiguration {
    #[must_use]
    /// Set the axis scale ([linear], [log10] or [log2]) for the summary plots.
    ///
